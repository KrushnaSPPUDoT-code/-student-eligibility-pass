// Network selection + per-network state file management for the Private
// Student Eligibility Pass.
//
// This module is structured to be extracted into a standalone package without
// code changes. Do not introduce template substitutions, sibling-template
// imports, or globals here. All side-effecting inputs flow through function
// parameters.
