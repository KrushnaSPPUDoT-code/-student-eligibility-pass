// Orchestrator for `npm run setup`. Brings up the local stack (or proof server
// for public networks), compiles, and deploys — branching on --network.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up Student Pass on network: ${network}\n\n`);
